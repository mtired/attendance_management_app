    ...
    <main class="request-list">
        <div class="request-list__inner">
            ...
            <div class="request-list__tabs">
                <a href="{{ route('attendance_change_request.index', ['tab' => 'pending']) }}"
                    class="request-list__tab {{ $activeTab === 'pending' ? 'is-active' : '' }}">
                    承認待ち
                </a>

                <a href="{{ route('attendance_change_request.index', ['tab' => 'approved']) }}"
